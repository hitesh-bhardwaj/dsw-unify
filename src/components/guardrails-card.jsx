  ...
  return (
    <>
      ...
      >
        <Card
          className={cn(
            "feature-card-hover-container overflow-hidden group hover:shadow-md cursor-pointer transition-all duration-300 bg-white border border-border-color-0 hover:border-white/20 !py-5 h-full flex justify-between"
          )}
        >
          <CardHeader>
            <div className="flex items-center justify-between gap-2">
              <div className="flex items-center gap-3">
                ...
                {isCustom && (
                  <Badge
                    variant="secondary"
                    className="rounded-full border border-border-color-2 px-3 py-1 dark:bg-card text-xs font-light transition-all duration-300 group-hover:text-white group-hover:border-white/60 bg-white/10 dark:group-hover:bg-white/10"
                  >
                    Custom
                  </Badge>
                )}
