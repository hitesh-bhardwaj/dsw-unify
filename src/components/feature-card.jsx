...
export function FeatureCard({ feature, minSkeletonMs = 500 }) {
  ...
  return (
    <div className="group w-full h-full">
      <Card
        className={cn(
          "h-full transition-all duration-300 hover:bg-sidebar-accent group gap-0 py-5 hover:border-border-color-2 cursor-pointer "
        )}
      >
...
>
  ...
  <pre
    className="w-full whitespace-pre bg-white dark:bg-background border-border-color-2 border dark:group-hover:bg-background overflow-x-auto rounded-lg  text-[#333333] dark:text-white  py-5 px-4 text-xs font-mono "
  >
  ...
  <div className="flex items-center gap-2  pl-2">
                <div className="w-4 h-4">
                  <Calendar className="text-[#333333] dark:text-white group-hover:text-foreground transition-all duration-500 ease-out  " />
                </div>
                <span className=" text-[#333333] dark:text-white text-xs "> Updated {lastUpdated}</span>
              </div>
