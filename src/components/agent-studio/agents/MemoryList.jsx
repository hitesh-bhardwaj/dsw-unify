...
export default function MemoriesList() {
  ...
  return (
    <div className="w-full border border-border-color-0 rounded-2xl p-6 bg-background">
      {/* HEADER */}
      ...
      <div className="space-y-3">
        {memoryOptions.map((mem) => (
          <div
            key={mem.id}
            className="flex items-center justify-start gap-5 border border-border-color-0 rounded-xl px-5 py-4 bg-background"
          >
            <Switch
