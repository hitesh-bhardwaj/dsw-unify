  ...
  return (
    ...
    <Card className="">
        <CardHeader className="space-y-0">
          <h1 className="text-2xl font-medium">Model Finetuning Configuration</h1>
          <p className="text-sm text-foreground/80">Configure custom model training and finetuning parameters</p>
        </CardHeader>
<CardContent>
        {/* Training Dataset */}
          ...
          <CardContent className="space-y-4 px-0">
            <div className="grid grid-cols-2 gap-4">
              <div className="space-y-2">
                ...
                <Select defaultValue="synthetic">
                  <SelectTrigger id="dataset-source" className="w-full py-5 border border-border-color-0 ">
                    <SelectValue placeholder="Select dataset source" />
                  </SelectTrigger>
                  <SelectContent>
                    <SelectItem value="synthetic">Generate Synthetic Data</SelectItem>
              ...
              <div className="space-y-2">
                ...
                <Select defaultValue="jsonl">
                  <SelectTrigger id="data-format" className="w-full py-5 border border-border-color-0">
            ...
            <div className="border border-border-color-0 rounded-lg p-12 cursor-pointer">
              <div className="flex flex-col items-center justify-center text-center">
                ...
                <p className="text-xs">Drag and drop, or browse files to upload</p>
              </div>
            </div>
          </CardContent>
        </Card>
          ...
          <CardContent className="space-y-6 px-0 py-0">
            <div className="grid grid-cols-2 gap-4">
              <div className="space-y-2">
                ...
                <Select defaultValue="gpt-4o-mini">
                  <SelectTrigger id="base-model" className="w-full py-5 border border-border-color-0">
            ...
            <div className="space-y-2">
              <div className="flex items-center justify-between">
                ...
                <span className="text-sm font-medium text-gray-700">{learningRate[0].toFixed(4)}</span>
              </div>
              <Slider
                value={learningRate}
                ...
                className="w-full"
              />
              <p className="text-xs text-gray-500">Controls how quickly the model learns</p>
            </div>

            <div className="space-y-2">
              <div className="flex items-center justify-between">
                <Label>Batch Size</Label>
                <span className="text-sm font-medium text-gray-700">{batchSize[0]}</span>
              </div>
              <Slider
                value={batchSize}
                ...
                className="w-full"
              />
              <p className="text-xs text-gray-500">Number of examples processed together</p>
            </div>
          </CardContent>
        </Card>
            ...
            <div className="grid grid-cols-2 gap-4">
              <div className="space-y-2">
                ...
                <Select defaultValue="20" >
                  <SelectTrigger id="validation-split" className="w-full py-5 border border-border-color-0">
