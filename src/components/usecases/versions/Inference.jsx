      ...
      <AnimatePresence mode="wait">
        ...
        {mode === "batch" && (
          ...
          >
            ...
            <div className="border rounded-3xl border-border-color-0 p-6 flex flex-col items-start gap-15 justify-start dark:bg-card">
        ...
        {mode === "single" && (
          ...
          >
            ...
            <div className="border rounded-3xl border-border-color-0 p-6 flex flex-col gap-6 dark:bg-card">
              <h2 className="text-xl font-medium">Prediction Result</h2>

              {/* Prediction badge */}
              <div className="bg-sidebar-accent border rounded-xl px-4 py-6 flex flex-col items-center dark:bg-card">
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <div className="border rounded-xl p-4 border-border-color-0 flex flex-col gap-2">
                  ...
                  <span className="text-3xl font-medium">
                    <CountUp value={confidence} startOnView />%
                  </span>
                ...
                <div className="w-full h-70  flex items-center justify-center">
                  <div className="h-full w-full">
                    <CustomBarChart
                      ...
                      bars={[
                        { dataKey: "score", name: "Score", color: "#2563FB" },
                      ]}
                    />
                  </div>
                </div>
              ...
              <div className="p-5 w-1/2 h-[25vw] border border-border-color-0 rounded-2xl space-y-6">
                ...
                <div className="h-64 w-full">
                  <CustomBarChart
                    ...
                    radius={[6, 6, 0, 0]}
                    bars={[
                      { dataKey: "score", name: "Score", color: "#7ED957" },
                    ]}
                  />
                </div>
              </div>
