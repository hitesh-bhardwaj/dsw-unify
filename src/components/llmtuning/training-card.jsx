          ...
          <div className="flex items-center w-full justify-between">
            ...
            <div className="flex items-center gap-2">
              <Button
                ...
                size="icon"
                className={cn(
                  "h-7 w-7 opacity-0 group-hover:opacity-100 flex items-center justify-center px-1 py-1 text-foreground dark:text-foreground hover:bg-sidebar-accent dark:hover:bg-white/30"
                )}
              >
                <Eye />
              </Button>
