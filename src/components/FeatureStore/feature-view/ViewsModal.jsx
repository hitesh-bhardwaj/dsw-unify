  ...
  const options = [
    {
      ...
      icon: <RegenerateIcon className="w-6 h-6 " />,
    },
    {
      id: "manual",
      ...
      icon: <CreateManuallyIcon className="w-6 h-6 " />,
    },
  ];
                ...
                <div className="w-full grid grid-cols-2 gap-4 mt-14 h-[55%]">
                  {options.map((item) => (
                    <div
                      ...
                      className={cn(
                        "feature-card-hover-container hover:text-white cursor-pointer p-8 group rounded-lg border border-border-color-2 hover:bg-sidebar-accent duration-500 transition-all flex items-center justify-center flex-col text-center space-y-4"
                      )}
                    >
                      <div className="pb-2 group-hover:text-white duration-300 transition-all">
                        {item.icon}
                      </div>
                      <h3 className="text-2xl group-hover:text-white  duration-300 transition-all font-medium">{item.title}</h3>
                      <p className="text-xs group-hover:text-white duration-300 transition-all  text-foreground/80 max-w-[80%]">
                        {item.description}
                      </p>
                    </div>
                  ))}
