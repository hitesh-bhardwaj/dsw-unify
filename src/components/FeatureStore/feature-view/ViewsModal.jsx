                ...
                <div className="w-full grid grid-cols-2 gap-4 mt-14 h-[55%]">
                  {options.map((item) => (
                    <div
                      ...
                      className={cn(
                        "feature-card-hover-container cursor-pointer p-8 group rounded-lg border border-border-color-2 hover:bg-sidebar-accent duration-500 transition-all flex items-center justify-center flex-col text-center space-y-4"
                      )}
                    >
