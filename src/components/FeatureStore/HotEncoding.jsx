...
const items = [
  ...
  },
  {
    ...
    label: "Code",
    name: "Code",
    render: () => <EmptyCard>No Code is available at this point</EmptyCard>,
  },
  {
    id: "tab-history",
    value: "history",
...
export default function HotEncoding({ open, onOpenChange }) {
  const [activeTab, setActiveTab] = useState("details");
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent
        className={"w-[80%] left-1/2 -translate-x-1/2 top-1/2 h-[80%] flex flex-col"}
      >
            <div className="px-2 pr-8 w-full h-fit">
              <DialogHeader>
