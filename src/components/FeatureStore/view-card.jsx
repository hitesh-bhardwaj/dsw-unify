  ...
  return (
    <div className="group w-full h-full">
      <Card
        ...
        className={cn(
          "feature-card-hover-container   transition-all duration-300 group",
      ...
      >
        ...
        >
          ...
          <div
            className={cn(
              "flex items-center rounded-lg p-3 px-5 text-sm py-6 duration-300 w-fit dark:bg-background bg-white/10 dark:group-hover:bg-white/10 group-hover:border-white/30 border border-border-color-2",
              `${isList ? "justify-start gap-10":"justify-between"}`
            )}
          >
