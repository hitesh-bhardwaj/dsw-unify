  ...
  return (
    ...
    >
      ...
      {showCloseButton && (
        <DialogPrimitive.Close
          data-slot="dialog-close"
          className="ring-offset-background w-6 h-6 cursor-pointer focus:ring-ring data-[state=open]:bg-accent data-[state=open]:text-muted-foreground absolute top-2 right-0 rounded-xs opacity-70 hover:opacity-100 focus:ring-0 focus:ring-offset-0 focus:outline-hidden disabled:pointer-events-none [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-4 hover:rotate-[90deg] duration-500 transition-all"
        >
          <XIcon className="!w-full !h-full" />
          <span className="sr-only">Close</span>
        </DialogPrimitive.Close>
