...
export default function DefineUseCases({ goNext, goBack, sharedState,
  ...
  const validate = () => {
    ...
    if (!name.trim()) {
      newErrors.name = "Use Case Name is required";
      valid = false;
    }
  ...
  return (
    <div className="space-y-2 pb-6 pr-2">
      {/* TITLE */}
      <h2 className="text-lg font-medium text-foreground">Define Use Case</h2>
      <p className="text-xs text-foreground/80">
        Define your business use case to organize your AI models
      </p>
      ...
      <div className="space-y-4 pt-4">
        ...
        <div className="space-y-2">
          ...
          <Textarea
            ...
            className="border border-border-color-0 mt-3  placeholder:text-foreground/80 placeholder:text-xs h-36"
