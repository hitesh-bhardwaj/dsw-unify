          ...
          <Card className={"border-none shadow-none "}>
            <CardContent className="pt-2 px-0">
              <Tabs defaultValue="prompt" className="w-full">
                ...
                <TabsContent value="knowledge" className={"border rounded-xl"}>
                  <div className="text-center py-12 text-gray-500">
                ...
                <TabsContent value="guardrails" className={"border rounded-xl"}>
                  <div className="text-center py-12 text-gray-500">
                    Guardrails configuration coming soon...
                  </div>
                </TabsContent>

                <TabsContent value="finetuning" className={"border rounded-xl"}>
                  <div className="text-center py-12 text-gray-500">
