        ...
        <div className=" bg-background p-6">
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-3 pb-4">
              <LeftArrowAnim link={`/agent-studio/prompts/${id}`} />

              <p className="text-sm">Back to Versions</p>
            </div>
          </div>
  ...
  {versionId ? `${versionId}` : ""}
            ...
            <div className="space-y-2">
              ...
              <p className="text-base text-foreground/80">
                Improved structure and added code examples support
              </p>
            </div>
            ...
            <div className="space-y-2">
              ...
              <div className="border border-border-color-0 rounded-xl p-4 bg-muted/30">
                <p className="font-mono text-sm leading-relaxed text-foreground">
                  You are an expert technical writer who creates clear,
                  comprehensive documentation. Use proper formatting, include
                  code examples where relevant, and structure content logically
            ...
            <div className="space-y-3">
              ...
              <div className="flex flex-wrap gap-3">
                <span className="px-4 py-1 rounded-full border border-border-color-0 text-xs text-foreground/80">
                  technical-writing
                </span>
                <span className="px-4 py-1 rounded-full border border-border-color-0 text-xs text-foreground/80">
                  documentation
